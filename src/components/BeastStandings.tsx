...
import { fetchBeastStandings } from "@/lib/api/yahooAuthService";
...
export default function BeastStandings() {
  const params = useParams<{ leagueKey: string }>();
      ...
      <TableContainer component={Paper}>
        <Table>
          <TableHead>
            <TableRow>
              <TableCell>#</TableCell>
              <TableCell onClick={() => handleSort("teamName")} style={{ cursor: "pointer" }}>
                Team
              </TableCell>
